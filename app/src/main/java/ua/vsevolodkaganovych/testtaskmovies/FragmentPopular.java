...
public class FragmentPopular extends ListFragment {
    ...
    private class Task extends AsyncTask<Void, Void, ArrayList<Item>> {
        ...
        protected ArrayList<Item> doInBackground(Void... params) {
            Request request = new Request.Builder()
                    .url("http://api.themoviedb.org/3/movie/popular?api_key=47e00b224e4f05989fa8b2a8d4ed7437&page=" + mPageNumber)
                    .build();
            try {
    ...
    private class LoadMoreData extends AsyncTask<Void, Void, ArrayList<Item>> {
        ...
        protected ArrayList<Item> doInBackground(Void... params) {
            Request request = new Request.Builder()
                    .url("http://api.themoviedb.org/3/movie/popular?api_key=47e00b224e4f05989fa8b2a8d4ed7437&page="
                            + (mPageNumber+=1))
                    .build();
            try {
                Response response = HttpApp.getOkHttpClient().newCall(request).execute();

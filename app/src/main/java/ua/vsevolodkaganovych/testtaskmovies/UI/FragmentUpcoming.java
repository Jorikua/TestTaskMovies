...
public class FragmentUpcoming extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ApiClient.getMovieApiInterface().getUpcoming(mPageNumber, new Callback<Result>() {
            @Override
            public void success(Result result, Response response) {
                ...
                getListView().setOnScrollListener(new EndlessScrollListener() {
                    ...
                    public void onLoadMore(int page, int totalItemsCount) {
                        ...
                        ApiClient.getMovieApiInterface().getUpcoming(mPageNumber += 1, new Callback<Result>() {
                            @Override
